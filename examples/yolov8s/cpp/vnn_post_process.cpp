...
vsi_status vnn_PostProcessYolov8sShapeSlimCUint8(vsi_nn_graph_t *graph, char* image_path)
{
    vsi_status status = VSI_FAILURE;
    /* Show result */
    status = show_result(graph, vsi_nn_GetTensor(graph, graph->output.tensors[0]), image_path);
