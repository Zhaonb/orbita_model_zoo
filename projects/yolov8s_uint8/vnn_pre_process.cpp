...
*/
vsi_status vnn_PreProcessYolov8sTestUint8_ImageProcess
    (
    vsi_nn_graph_t *graph,
    const char **inputs,
    uint32_t input_num
    )
{
    ...
    {
        printf("vnn_PreProcessYolov8sTestUint8_ImageProcess Only support JPG image file\n");
        status = VSI_FAILURE;
        TEST_CHECK_STATUS(status, final);
    }
...
vsi_status vnn_PreProcessYolov8sTestUint8
    (
    vsi_nn_graph_t *graph,
    const char **inputs,
    uint32_t input_num
