...
vsi_nn_preprocess_source_layout_e source_layout_for_norm_tensor_6 = VSI_NN_SOURCE_LAYOUT_NCHW;
vsi_nn_preprocess_source_format_e source_format_for_norm_tensor_6 = VSI_NN_SOURCE_FORMAT_IMAGE_RGB;
vsi_nn_preprocess_image_size_t size_for_norm_tensor_6 = {640, 640, 3};

vsi_nn_preprocess_image_resize_t resize_for_norm_tensor_6 = {640, 640, 3};
int8_t reverse_channel_for_norm_tensor_6 = 1;
float mean_and_scale_6[] = {0, 0, 0};
vsi_nn_preprocess_mean_and_scale_t mean_and_scale_for_norm_tensor_6 = {mean_and_scale_6, 3, 0.003921569};
int32_t perm_6[] = {0, 1, 2, 3};
vsi_nn_preprocess_permute_t permute_for_norm_tensor_6 = {perm_6, 4};
vsi_nn_preprocess_base_t pre_process_for_norm_tensor_6[] =
        {
                {VSI_NN_PREPROCESS_SOURCE_LAYOUT, &source_layout_for_norm_tensor_6},
                {VSI_NN_PREPROCESS_SET_SOURCE_FORMAT, &source_format_for_norm_tensor_6},

                {VSI_NN_PREPROCESS_IMAGE_SIZE, &size_for_norm_tensor_6},
                {VSI_NN_PREPROCESS_IMAGE_RESIZE_BILINEAR, &resize_for_norm_tensor_6},
                {VSI_NN_PREPROCESS_REVERSE_CHANNEL, &reverse_channel_for_norm_tensor_6},
                {VSI_NN_PREPROCESS_MEAN_AND_SCALE, &mean_and_scale_for_norm_tensor_6},
                {VSI_NN_PREPROCESS_PERMUTE, &permute_for_norm_tensor_6},
        };

/*{graph_input_idx, preprocess}*/
const static vsi_nn_preprocess_map_element_t preprocess_map[] =
        {
                {0, pre_process_for_norm_tensor_6, sizeof(pre_process_for_norm_tensor_6) / sizeof(vsi_nn_preprocess_base_t)},
        };
/*-------------------------------------------
                  Functions
-------------------------------------------*/
...
*/
vsi_status vnn_PreProcessYolov8sShapeSlimCUint8_ImageProcess
    (
    vsi_nn_graph_t *graph,
    const char **inputs,
    uint32_t input_num
    )
{
    ...
    {
        printf("vnn_PreProcessYolov8sShapeSlimCUint8_ImageProcess Only support JPG image file\n");
        status = VSI_FAILURE;
        TEST_CHECK_STATUS(status, final);
    }
...
vsi_status vnn_PreProcessYolov8sShapeSlimCUint8
    (
    vsi_nn_graph_t *graph,
    const char **inputs,
    uint32_t input_num
