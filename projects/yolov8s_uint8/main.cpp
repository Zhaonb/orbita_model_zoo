...
{
    vnn_ReleaseYolov8sTestUint8( graph, TRUE );
...
{
    return vnn_PostProcessYolov8sTestUint8(graph, image_path);
}
    ...
    )
{
    ...
    if(vnn_UseImagePreprocessNode())
    {
        return vnn_PreProcessYolov8sTestUint8_ImageProcess(graph, inputs, input_num);
    }
    */
    return vnn_PreProcessYolov8sTestUint8( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov8sTestUint8( data_file_name, NULL,
